            ...
            <Row style={{ padding: '16px', background: '#fff', borderRadius: '4px', height:'100%' }}>
                ...
                <Col span={14} style={{ paddingLeft: '10px' }}>
                    ...
                    <div style={{fontSize:"16px"}} >
                        ...
                        <Rate style={{marginLeft:"4px"}}  allowHalf defaultValue={productDetails?.rating} value={productDetails?.rating} />
                    ...
                    <WrapperPriceProduct>
                        ...
                        <div style={{ height:"",fontSize:"12px",marginLeft:"10px",background:'red',color:"#fff"}}>giảm {productDetails?.discount}%</div>
