    ...
    <div style={{background: '#f5f5fa', with: '100%', height: '100vh'}}>
      <Loading isLoading={false}>
        <div style={{height: '100%', width: '1270px', margin: '0 auto'}}>
          <h3 style={{display:"flex",justifyContent:"center"}}>Đơn hàng đặt thành công</h3>
                  ...
                  return (
                    <WrapperItemOrder key={order?.name}>
                      ...
                      <div style={{flex: 1, display: 'flex', alignItems: 'center',gap: '10px'}}>
                        ...
                        <span>
                          <span style={{ margin:"0 20px", fontSize: '13px', color: '#242424' }}>Tổng số tiền: {convertPrice(order?.price * order?.amount)}</span>
                        </span>
                      </div>
                    </WrapperItemOrder>
                  )
